...
// RawMilkMilkTankWithHistory is an auto generated low-level Go binding around an user-defined struct.
type RawMilkMilkTankWithHistory struct {
	TankId           [32]byte
...
func (_Rawmilk *RawmilkCaller) GetMilkTank(opts *bind.CallOpts, _tankId [32]byte) (RawMilkMilkTankWithHistory, error) {
	var out []interface{}
	err := _Rawmilk.contract.Call(opts, &out, "getMilkTank", _tankId)

	if err != nil {
		return *new(RawMilkMilkTankWithHistory), err
	}

	out0 := *abi.ConvertType(out[0], new(RawMilkMilkTankWithHistory)).(*RawMilkMilkTankWithHistory)
...
//
// Solidity: function getMilkTank(bytes32 _tankId) view returns((bytes32,address,bytes32,string,uint8,string,string,(string,string,uint8,uint256)[]))
func (_Rawmilk *RawmilkSession) GetMilkTank(_tankId [32]byte) (RawMilkMilkTankWithHistory, error) {
...
//
// Solidity: function getMilkTank(bytes32 _tankId) view returns((bytes32,address,bytes32,string,uint8,string,string,(string,string,uint8,uint256)[]))
func (_Rawmilk *RawmilkCallerSession) GetMilkTank(_tankId [32]byte) (RawMilkMilkTankWithHistory, error) {
	return _Rawmilk.Contract.GetMilkTank(&_Rawmilk.CallOpts, _tankId)
}
...
// FilterMilkTankCreated is a free log retrieval operation binding the contract event 0x0412e476b8c12bf5775d0ab8bb60f9d773ac47a29447b7b972f92c1e8e810994.
//
// Solidity: event MilkTankCreated(bytes32 indexed tankId, address indexed farmer, bytes32 indexed factoryId, string personInCharge, string qualityReportCID, uint8 status)
...
// WatchMilkTankCreated is a free log subscription operation binding the contract event 0x0412e476b8c12bf5775d0ab8bb60f9d773ac47a29447b7b972f92c1e8e810994.
//
// Solidity: event MilkTankCreated(bytes32 indexed tankId, address indexed farmer, bytes32 indexed factoryId, string personInCharge, string qualityReportCID, uint8 status)
...
// ParseMilkTankCreated is a log parse operation binding the contract event 0x0412e476b8c12bf5775d0ab8bb60f9d773ac47a29447b7b972f92c1e8e810994.
//
// Solidity: event MilkTankCreated(bytes32 indexed tankId, address indexed farmer, bytes32 indexed factoryId, string personInCharge, string qualityReportCID, uint8 status)
