...
// GetLastLogisticsProvider is a free data retrieval call binding the contract method 0xcfd7b9af.
//
// Solidity: function getLastLogisticsProvider(bytes32 _trackingId) view returns(address)
func (_Tracking *TrackingCaller) GetLastLogisticsProvider(opts *bind.CallOpts, _trackingId [32]byte) (common.Address, error) {
	var out []interface{}
	err := _Tracking.contract.Call(opts, &out, "getLastLogisticsProvider", _trackingId)
...
//
// Solidity: function getLastLogisticsProvider(bytes32 _trackingId) view returns(address)
func (_Tracking *TrackingSession) GetLastLogisticsProvider(_trackingId [32]byte) (common.Address, error) {
	return _Tracking.Contract.GetLastLogisticsProvider(&_Tracking.CallOpts, _trackingId)
}

// GetLastLogisticsProvider is a free data retrieval call binding the contract method 0xcfd7b9af.
//
// Solidity: function getLastLogisticsProvider(bytes32 _trackingId) view returns(address)
func (_Tracking *TrackingCallerSession) GetLastLogisticsProvider(_trackingId [32]byte) (common.Address, error) {
	return _Tracking.Contract.GetLastLogisticsProvider(&_Tracking.CallOpts, _trackingId)
}
...
// GetOngoingShipmentsByLogistics is a free data retrieval call binding the contract method 0x8120b3f7.
//
// Solidity: function getOngoingShipmentsByLogistics() view returns(bytes32[] trackingIds, string[] personInChargeList)
func (_Tracking *TrackingCaller) GetOngoingShipmentsByLogistics(opts *bind.CallOpts) (struct {
	TrackingIds        [][32]byte
	PersonInChargeList []string
}, error) {
	var out []interface{}
	err := _Tracking.contract.Call(opts, &out, "getOngoingShipmentsByLogistics")
	...
	outstruct.TrackingIds = *abi.ConvertType(out[0], new([][32]byte)).(*[][32]byte)
	outstruct.PersonInChargeList = *abi.ConvertType(out[1], new([]string)).(*[]string)
...
//
// Solidity: function getOngoingShipmentsByLogistics() view returns(bytes32[] trackingIds, string[] personInChargeList)
func (_Tracking *TrackingSession) GetOngoingShipmentsByLogistics() (struct {
	TrackingIds        [][32]byte
	PersonInChargeList []string
}, error) {
	return _Tracking.Contract.GetOngoingShipmentsByLogistics(&_Tracking.CallOpts)
}

// GetOngoingShipmentsByLogistics is a free data retrieval call binding the contract method 0x8120b3f7.
//
// Solidity: function getOngoingShipmentsByLogistics() view returns(bytes32[] trackingIds, string[] personInChargeList)
func (_Tracking *TrackingCallerSession) GetOngoingShipmentsByLogistics() (struct {
	TrackingIds        [][32]byte
	PersonInChargeList []string
}, error) {
	return _Tracking.Contract.GetOngoingShipmentsByLogistics(&_Tracking.CallOpts)
